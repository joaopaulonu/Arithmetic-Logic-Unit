-- ============================================================
-- Arquivo: alu_pkg.vhd
-- Descricao: Package (pacote) com a declaracao de todos os
-- componentes usados na ULA. Centraliza as declaracoes para
-- facilitar o reuso e a organizacao do projeto.
-- ============================================================
