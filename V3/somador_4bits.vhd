-- ============================================================
-- Arquivo: adder4.vhd
-- Descricao: Somador/Subtrator Ripple Carry de 4 bits
-- Usa 4 instancias do full_adder encadeadas
-- Para subtrair: inverte b e coloca cin=1 (complemento de 2)
-- ============================================================
...
architecture ripple_carry of adder4 is
    ...
    -- Declaracao do componente full_adder (deve existir como arquivo separado)
