-- ============================================================
-- Arquivo: alu.vhd
-- Descricao: Unidade Logica e Aritmetica (ULA) de 4 bits corrigida
-- Realiza: NOP, AND, OR, NOT, ADD, SUB, MUL, COMP
-- Mapeamento de pinos para a placa DE2-115 (Cyclone IV)
-- ============================================================
