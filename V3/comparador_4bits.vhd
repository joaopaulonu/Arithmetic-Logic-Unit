-- ============================================================
-- Arquivo: comparator4.vhd
-- Descricao: Comparador de dois numeros de 4 bits
-- Saidas: equ=1 se a=b, grt=1 se a>b, lst=1 se a<b
-- Metodo: comparacao bit a bit do mais significativo ao menos
-- ============================================================
